...
class TokensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create token" do
    assert_difference('Token.count') do
      post tokens_url, params: { token: { social_name: @token.social_name, token_use: @token.token_use } }
    end
  ...
  test "should update token" do
    patch token_url(@token), params: { token: { social_name: @token.social_name, token_use: @token.token_use } }
